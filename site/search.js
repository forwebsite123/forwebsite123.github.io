(function () {
  ...
  .search-icon::after {
    ...
    background:
      radial-gradient(circle,
        rgba(255,252,240,.60) 0%,
        rgba(252,242,215,.26) 34%,
        rgba(236,205,145,.11) 58%,
        rgba(236,205,145,0) 76%);
    opacity: 0;
    pointer-events: none;
    z-index: -1;
  }
  ...
  .search-icon:hover {
    text-shadow:
      0 0 5px rgba(255,252,240,.54),
      0 0 12px rgba(252,242,215,.32),
      0 0 22px rgba(236,205,145,.16);
    filter:
      drop-shadow(0 0 7px rgba(252,242,215,.24))
      drop-shadow(0 0 12px rgba(236,205,145,.10));
  ...
  @media (prefers-reduced-motion: reduce) {
    ...
    .search-icon:hover {
      transform: none;
      text-shadow:
        0 0 5px rgba(255,252,240,.48),
        0 0 12px rgba(252,242,215,.26);
      filter:
        drop-shadow(0 0 7px rgba(252,242,215,.20));
    }
  }
`;
  ...
  function injectHomeGrowthSignStyle() {
    ...
    style.textContent = `
      ...
      @media (max-width: 520px) {
        ...
        .tree-main, .main-tree, .growth-tree-main, .tree-image, .tree-art { width: min(calc(100vw - 18px), 548px) !important; max-height: 760px !important; display: block !important; margin-left: auto !important; margin-right: auto !important; object-position: center top !important; -webkit-mask-image: radial-gradient(ellipse 76% 90% at 50% 52%, #000 44%, rgba(0,0,0,.58) 70%, rgba(0,0,0,0) 98%) !important; mask-image: radial-gradient(ellipse 76% 90% at 50% 52%, #000 44%, rgba(0,0,0,.58) 70%, rgba(0,0,0,0) 98%) !important; }
